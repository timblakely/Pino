...
ETL_BFF_REG_RW(uint32_t, SMCR,
  ...
  ETL_BFF_FIELD_E(2:0, uint8_t, SMS,
    ETL_BFF_ENUM(0b000, disabled)
    ETL_BFF_ENUM(0b001, encoder_1)
    ETL_BFF_ENUM(0b010, encoder_2)
    ETL_BFF_ENUM(0b011, encoder_3)
    ETL_BFF_ENUM(0b100, reset)
    ETL_BFF_ENUM(0b101, gated)
    ETL_BFF_ENUM(0b110, trigger)
    ETL_BFF_ENUM(0b111, external_clock_1)
  )
)
